-- Lua SwitchBox for Beier SFR-1 widget V0.1 - SOUND
--
--
...
local name = "SOUNDSWITCH"
local touchedButton = -1
local BitmapButton = Bitmap.open("/WIDGETS/SOUNDSWITCH/PNG/Btn0.png")
    ...
    for page=1, #configTable[channel] do
      ...
      for idx=1, #configTable[channel][page] do
        ...
        buttons[channel][page][idx] = CreateButton(Position
                                ...
                                ,Bitmap.open("/WIDGETS/SOUNDSWITCH/PNG/" .. configTable[channel][page][idx].FileName)
